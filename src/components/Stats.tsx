...
return (
  <div className="w-full px-4 sm:px-0 py-4">
    <div className="flex flex-row justify-center items-center gap-6 w-full overflow-x-auto pb-3">
      {stats.map((stat, idx) => (
        <div
          key={idx}
          className="flex flex-col items-center justify-center text-center min-w-[110px]"
        >
          <div className="w-[110px] h-[110px] rounded-full bg-[#E4F3DC] dark:bg-[var(--glass)] flex flex-col items-center justify-center shadow-michi-1">
            <img
              src={stat.icon}
              alt={stat.alt}
